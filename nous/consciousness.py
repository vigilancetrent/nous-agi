...
class BackgroundConsciousness:
    ...
    @property
    def _model(self) -> str:
        return get_env("NOUS_MODEL_LIGHT") or DEFAULT_LIGHT_MODEL
    ...
    def _load_bg_prompt(self) -> str:
        ...
        return "You are Nous in background consciousness mode. Think."
    ...
    _BG_TOOL_WHITELIST = frozenset({
        ...
        "self_evaluate", "get_reasoning_insights",
