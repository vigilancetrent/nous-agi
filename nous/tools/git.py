...
from nous.utils import utc_now_iso, write_text, safe_relpath, run_cmd
...
def _run_pre_push_tests(ctx: ToolContext) -> Optional[str]:
    ...
    if get_env("NOUS_PRE_PUSH_TESTS", "1") != "1":
        return None
...
def get_tools() -> List[ToolEntry]:
    return [
        ToolEntry("repo_write_commit", {
            ...
            "description": "Write one file + commit + push to nous branch. For small deterministic edits.",
