...
def _set_goal(ctx: ToolContext, **args) -> str:
...
def _list_goals(ctx: ToolContext, **args) -> str:
    tree = _get_tree(ctx)
    return tree.get_goal_tree()


def _update_goal(ctx: ToolContext, **args) -> str:
    tree = _get_tree(ctx)
...
def _suggest_goals(ctx: ToolContext, **args) -> str:
    tree = _get_tree(ctx)
