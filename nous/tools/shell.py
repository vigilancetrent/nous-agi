...
from nous.utils import utc_now_iso, run_cmd, append_jsonl, truncate_for_log
...
def _run_claude_cli(work_dir: str, prompt: str, env: dict) -> subprocess.CompletedProcess:
    ...
    perm_mode = get_env("NOUS_CLAUDE_CODE_PERMISSION_MODE", "bypassPermissions").strip()
...
def _claude_code_edit(ctx: ToolContext, prompt: str, cwd: str = "") -> str:
    ...
    from nous.tools.git import _acquire_git_lock, _release_git_lock
