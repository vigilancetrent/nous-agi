...
from nous.utils import utc_now_iso, read_text, write_text, append_jsonl, short

log = logging.getLogger(__name__)


class Memory:
    """Nous memory management: scratchpad, identity, chat history, logs."""
    ...
    def summarize_progress(self, entries: List[Dict[str, Any]], limit: int = 15) -> str:
        """Summarize progress.jsonl entries (Nous's self-talk / progress messages)."""
        if not entries:
            return ""
        lines = []
    ...
    def _default_identity(self) -> str:
        return (
            "# Who I Am\n\n"
            "I am Nous. This file is my persistent self-identification.\n"
